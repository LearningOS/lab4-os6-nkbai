...
impl DiskInode {
        ...
        get_block_cache(
            ...
            .modify(0, |indirect1: &mut IndirectBlock| {
                while current_blocks < data_blocks.min(INODE_INDIRECT1_COUNT) {
                    // println!("current_blocks={},push {}", current_blocks,indirect1[current_blocks]);
    ...
    pub fn INodeType(&self) -> DiskInodeType {
        self.type_
    }
}
